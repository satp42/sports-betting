...
| 0.2 | Set up API keys for data sources: The Odds API for betting odds and Ball Don't Lie NBA API for basketball data. ([The Odds API](https://the-odds-api.com "The Odds API"), [Ball Don't Lie API](https://api.balldontlie.io "Ball Don't Lie NBA API"))                                                                                                                                                                                                                                                                                | `.env`file contains `THE_ODDS_API_KEY` and `NBA_API_KEY`. |
...
| 3.2 | Implement REST fetch of NBA odds from The Odds API (`/v4/sports/basketball_nba/odds`). ([The Odds API](https://the-odds-api.com/liveapi/guides/v4/ "The Odds API Documentation"))                         | Logs show JSON payload. |
...
| #   | Task                                                                                                                                                                                                                                         | Done when |
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| 4.1 | Write Python module `features.py`that joins `games`+ last 10 `odds_snapshots`+ Ball Don't Lie team stats. ([Ball Don't Lie API](https://api.balldontlie.io "Ball Don't Lie NBA API Documentation")) |           |
...
| 6.4 | Simulate bet placement logic; log bet details and return mock transaction hash. (For demo purposes - replace with real betting integration when available)                                                                                     |                  |
